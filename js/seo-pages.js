(() => {
  ...
  const pricingEntries = [
    ...
    ['* Минимальный срок подписки — 3 месяца.', '* Minimum support term — 3 months.'],
    ['Подробнее — в правилах поддержки.', 'Details are in the support rules.'],
  ...
  const supportEntries = [
    ...
    ['05 / Правила', '05 / Rules'],
    ['Условия работы по подписке', 'Support terms'],
    ['Крупные изменения и срочные задачи не входят в подписку — их оцениваем и оплачиваем отдельно. Также фиксируем момент начала работ и минимальный срок поддержки.', 'Major changes and urgent tasks are not included in the subscription — they are estimated and paid for separately. We also confirm when work begins and the minimum support term.'],
    ...
    ['Минимальный срок подписки', 'Minimum support term'],
    ['Подписка на поддержку оформляется на минимальный срок 3 месяца. Это время нужно, чтобы команда погрузилась в проект, а изменения дали заметный результат. Отменить подписку раньше этого срока нельзя — при досрочном отказе оплачиваются оставшиеся месяцы до истечения минимального периода.', 'Support is purchased for a minimum term of 3 months. This gives the team time to understand the product and lets the changes produce a noticeable result. The subscription cannot be cancelled before the minimum term ends; if cancelled early, the remaining months of the minimum period must still be paid.'],
    ...
    ['Минимальный срок подписки — 3 месяца; до его окончания при отказе оплачиваются оставшиеся месяцы. После минимального периода срок уведомления, дата окончания работ и передача незавершённых материалов фиксируются в предложении до старта.', 'The minimum support term is 3 months; if cancelled before it ends, the remaining months must still be paid. After the minimum period, the notice period, end date and handoff of unfinished materials are stated in the proposal before support begins.'],
  ...
  const portfolioEntries = [
    ...
    ['Сайт Solo Space в мокапе смартфона', 'Solo Space website shown in a phone mockup'],
    ['Собрали сайт студии бесшовных покрытий в Астане: услуги, фактуры и заявка на предварительный расчёт работают как один мобильный сценарий.', 'We built a website for an Astana seamless-surfaces studio where services, textures and the preliminary estimate request work as one mobile journey.'],
    ['Сложные материалы и фактуры трудно сравнить по разрозненным фотографиям и сообщениям.', 'Complex materials and textures are difficult to compare through scattered photos and messages.'],
    ['Связали услуги, каталог с фильтрами, процесс, FAQ и форму расчёта в одной адаптивной странице.', 'We connected services, a filtered catalog, process, FAQ and estimate form in one responsive page.'],
    ['Посетитель выбирает покрытие, изучает фактуры и отправляет исходные данные для расчёта с телефона.', 'Visitors choose a surface, explore textures and submit the details needed for an estimate from their phone.'],
    ['Открыть сайт', 'Open website'],
    ['Сайт студии массажа Myoneuromassage в мобильном формате', 'Myoneuromassage studio website shown on mobile'],
    ['Собрали спокойный и понятный лендинг студии массажа в Алматы: услуги, доверие, адрес и запись связаны в один короткий мобильный сценарий.', 'We built a calm, clear landing page for an Almaty massage studio, connecting services, trust, location and booking in one concise mobile journey.'],
    ['Услуги требовали деликатной подачи, а посетителю нужно было быстро понять формат массажа и способ записи.', 'The services needed a thoughtful presentation while visitors had to understand the massage format and booking path quickly.'],
    ['Сфокусировали структуру на ощущении доверия, понятном описании процедур, локальном SEO и прямом контакте.', 'We focused the structure on trust, clear treatment descriptions, local SEO and direct contact.'],
    ['Студия получила цельную страницу для рекламы и органического поиска с удобной записью с телефона.', 'The studio received a cohesive page for advertising and organic search with convenient mobile booking.'],
  ...
  const metadata = {
    ...
    portfolio: {
      ru: {
        ...
        description: 'Кейсы Mononyxx: задачи, решения и результаты в приложении Star Kids, сайтах Solo Space и Myoneuromassage.',
